  ...
  return (
    ...
    >
      <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white leading-tight">
        ...
        soy{" "}
        <span
          className="text-blue-600 dark:text-blue-400 inline-block opacity-0 animate-fadeInUp"
      ...
      <p
        className="text-lg sm:text-xl text-gray-700 dark:text-gray-300 font-semibold tracking-wide inline-block opacity-0 animate-fadeInUp"
      ...
      <div className="bg-gray-250 dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-900 rounded-xl p-8 sm:p-12 shadow-md dark:shadow-lg transition-all duration-300">
